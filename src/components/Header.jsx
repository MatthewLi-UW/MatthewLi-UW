    ...
    return (
        ...
        bg-gradient-to-b from-zinc-900 to-zinc-900/0">
          ...
          md:grid md:px-6 md:grid-cols-[1fr,3fr,1fr]">
            ...
            <div className="relative flex items-center gap-2 md:justify-self-center">
              <a
                href="https://stakky.dev"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Stakky"
                className="w-10 h-10 rounded-xl grid place-items-center ring-1 ring-zinc-50/10 text-zinc-300 hover:text-white hover:bg-zinc-50/10 transition-colors md:hidden"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 grid place-items-center text-zinc-300 hover:text-white transition-colors md:hidden"
              >
                <span className="text-xl font-bold leading-none tracking-tight">in</span>
              </a>
            ...
            <div className="flex items-center gap-4 md:justify-self-end max-md:hidden">
              <a
                ...
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 grid place-items-center text-zinc-300 hover:text-white transition-colors"
              >
                <span className="text-xl font-bold leading-none tracking-tight">in</span>
              </a>
